...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Ensure microphone permission prompt is shown for new users
        MicrophonePermissionManager.shared.requestPermission(completion: nil)
        ...
        // Also handled in onboarding; central manager ensures prompt for first launch
    ...
    // Removed old inline mic permission method in favor of MicrophonePermissionManager
}
